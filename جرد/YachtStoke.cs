...
namespace جرد
{
    public partial class YachtStoke : Form
    {
        public YachtStoke()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            String query = "select * from YachetStoke";
        ...
        private void YachtStoke_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "insert into YachetStoke values(N'" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO YachetStoke (الصنف,العدد,المفقود,الهالك) VALUES " +
        ...
        {
            Con.Open();
            string query = "update YachetStoke set الصنف=N'" + textBox1.Text + "',العدد='" + textBox2.Text + "',المفقود='" + textBox3.Text + "',الهالك='" + textBox4.Text + "' where الصنف=N'" + textBox1.Text + "';";
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from YachetStoke where الصنف=N'" + textBox1.Text + "';";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dgvprinter.Title = "جرد مخزن المركب";
