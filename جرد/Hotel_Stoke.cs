...
namespace جرد
{
    public partial class Hotel_Stoke : Form
    {
        public Hotel_Stoke()
        {
            InitializeComponent();
        ...
        private void Hotel_Stoke_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Hotel_Stoke";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dgvprinter.Title = "مشتريات الفندق";
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from Hotel_Stoke where الصنف=N'" + textBox1.Text + "';";
        ...
        private void UpdateBtn_Click(object sender, EventArgs e)
        {
            ...
            Con.Open();
            string query = "update Hotel_Stoke set الصنف=N'" + textBox1.Text + "',العدد='" + textBox2.Text + "',السعر='" + textBox3.Text + "',التاريخ='" + dateTimePicker1.Value.Date + "',الاجمالى='" + label8.Text + "' where الصنف=N'" + textBox1.Text + "';";
            SqlCommand cmd = new SqlCommand(query, Con);
            cmd.ExecuteNonQuery();
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            Con.Open();
            String query = "insert into Hotel_Stoke values(N'" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + dateTimePicker1.Value.Date + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO Hotel_Stoke (الصنف,العدد,السعر,التاريخ,الاجمالى) VALUES " +
