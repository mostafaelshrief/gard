...
namespace جرد
{
    public partial class Ketchen_Stoke : Form
    {
        public Ketchen_Stoke()
        {
            InitializeComponent();
        }
        ...
        private void Ketchen_Stoke_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Ketchen_Stoke";
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            Con.Open();
            String query = "insert into Ketchen_Stoke values(N'" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + dateTimePicker1.Value.Date + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO Ketchen_Stoke (الصنف,العدد,السعر,التاريخ,الاجمالى) VALUES " +
        ...
        private void UpdateBtn_Click(object sender, EventArgs e)
        {
            ...
            Con.Open();
            string query = "update Ketchen_Stoke set الصنف=N'" + textBox1.Text + "',العدد='" + textBox2.Text + "',السعر='" + textBox3.Text + "',التاريخ='" + dateTimePicker1.Value.Date + "',الاجمالى='" + label8.Text + "' where الصنف=N'" + textBox1.Text + "';";
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from Ketchen_Stoke where الصنف=N'" + textBox1.Text + "';";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dgvprinter.Title = "مشتريات المطبخ";
