...
namespace جرد
{
    public partial class Ketchen : Form
    {
        public Ketchen()
        {
            InitializeComponent();
        ...
        {
            Con.Open();
            String query = "insert into Ketchen values(N'" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO Ketchen (الصنف,العدد,المفقود,الهالك) VALUES " +
        ...
        private void Ketchen_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        {
            Con.Open();
            String query = "select * from Ketchen";
        ...
        {
            Con.Open();
            string query = "update Ketchen set الصنف=N'" + textBox1.Text + "',العدد='" + textBox2.Text + "',المفقود='" + textBox3.Text + "',الهالك='" + textBox4.Text + "' where الصنف=N'" + textBox1.Text + "';";
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from Ketchen where الصنف=N'" + textBox1.Text + "';";
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
