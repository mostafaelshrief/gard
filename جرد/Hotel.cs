...
namespace جرد
{
    public partial class Hotel : Form
    {
        ...
        {
            Con.Open();
            String query = "insert into Hotel values(N'" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "')";
            SqlCommand cmd = new SqlCommand("INSERT INTO Hotel (الصنف,العدد,المفقود,الهالك) VALUES " +
        ...
        private void DeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String query = "delete from Hotel where الصنف=N'" + textBox1.Text + "';";
        ...
        {
            Con.Open();
            string query = "update Hotel set الصنف=N'" + textBox1.Text + "',العدد='" + textBox2.Text + "',المفقود='" + textBox3.Text + "',الهالك='"+ textBox4.Text + "' where الصنف=N'" + textBox1.Text + "';";
            SqlCommand cmd = new SqlCommand(query, Con);
            cmd.ExecuteNonQuery();
